...
function showHotAdvise(){
    var adviseContent='<h1 class="notice_title">'+JSONData.name+'</h1><ul class="pic_list3">';
var turnShow=getRandomNum(9,0,14);
for(var i=0;i<turnShow.length;i++){
    var adviseContent=adviseContent+'<li><a href="'+JSONData.data[index].href
        +'"><img src="'+JSONData.srcPath+JSONData.data[index].src
        +'" width="80" height="80"></a><p class="prace2">$'
